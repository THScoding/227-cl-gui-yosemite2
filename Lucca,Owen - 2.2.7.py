...
''' def show_ping_options():
    ...
    check_ping_infinite.pack_forget()
    check_ping_count.pack_forget()
    check_ping_size.pack_forget()
    check_ping_timeout.pack_forget()
    check_ping_hops.pack_forget()
    check_ping_version.pack_forget()
